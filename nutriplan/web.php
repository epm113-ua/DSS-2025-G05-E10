...
Route::middleware(['auth','rol:paciente'])->prefix('paciente')->name('paciente.')->group(function(){
    ...
    Route::patch('/mi-perfil',     [PacientePanelController::class,'actualizarPerfil'])->name('mi-perfil.update');
...
Route::middleware(['auth','rol:nutricionista,admin'])->group(function(){
    ...
    // Fijar nombres de parámetro explícitos para evitar errores de pluralización
