...
<nav class="topnav">
    <div class="topnav-inner">
        ...
        <div class="nav-links">
            ...
            <div class="nav-sep"></div>
            <a href="{{ route('mensajes.chat') }}"   class="nav-item {{ request()->routeIs('mensajes.chat') || request()->routeIs('conversaciones.*') ? 'active':'' }}"><i class="bi bi-chat-dots"></i><span>Mensajes</span></a>
            <div class="nav-sep"></div>
        ...
        <div class="nav-user">
            ...
            <x-avatar :foto="$n?->foto" :nombre="Auth::user()->name" :size="32" />
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('conversaciones.index') }}"    class="nav-link {{ request()->routeIs('conversaciones.*') || request()->routeIs('mensajes.*') ? 'active':'' }}"><i class="bi bi-chat-dots"></i> Conversaciones</a>
